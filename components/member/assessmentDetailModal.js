...
module.exports = function () {
  return h('div.modal-content', [
    h('div.modal-header', [
      ...
      //   }, '×')
      // ]),
      h('h4#myModalLabel.modal-title', 'Edit Assessment')
    ]),
    h('form', [
      h('div', [
        h('.col-md-6.courseInfo', [
          ...
          h('input.form-control', {
            'type': 'text',
            'data-ng-model': 'currentAssessment.locationVal',
            'required': ''
          })
        ]),
        h('.col-md-6.courseInfo', [
        ...
        h('.col-md-6.courseInfo', [
          ...
          h('select.form-control', {
            'id': 'trainerControl',
            'data-ng-model': 'currentAssessment.trainer'
          }, [
            h('option', {
    ...
    h('.modal-footer', [
      h('.col-md-8', {
        ...
        h('.lincBtn', {
          'type': 'button',
          'data-ng-click': 'updateCurrentAssessment(currentAssessment)',
          'style': 'float: left;'
        }, 'Save')
      ])
    ])
